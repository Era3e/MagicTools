...
- **已完成**：6 项 ✅ — D-05（Scholar 图谱 G6 交互 PR #38）、D-07（Investigator Cron PR #36）、D-10（Gateway 健康仪表盘 PR #35）、D-11（0 bug loop PR #35）、D-16（Designer 前台 nav PR #39）、D-17（Assistant 意图日志 nav 已落地）
- **剩余**：12 项（原 18 项，减去已完成 6 项）
