...
- **PR 清理战役收官（2026-08-29，#39 关闭）**：8 个 open PR 全部处置完毕——7 个合并（#43/36/37/41/40/38/42，均 squash + CI 三段全绿 + 分支清理）、1 个关闭（#39：D-16 主体与 lint 修复均被后续 PR 覆盖，附关闭说明评论；其唯一有效内容 coverage-matrix Sc10 行已直接补入 main，顺带更新 Sc11 反映 D-06 冲突合并，269a1a3）。**本地/远程分支仅剩 main，工作区干净**。mvp-deferred 18 项 → 16 项兑现合并，剩余 4 项真延期（D-01/02 拖拽编辑器、D-09 LoRA 层、D-15 投递日历、D-18 linux 视觉基线，触发条件见各该行）；
